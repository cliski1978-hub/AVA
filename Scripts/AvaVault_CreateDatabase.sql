-- ============================================================
-- AVA Vault — Full Database Reset Script
-- Creates database, drops all existing tables, recreates fresh
-- ============================================================
-- How to run:
--   Open this file in SSMS, connect to WITMNCND3112P9Q, and execute (F5)
-- ============================================================

-- Step 1: Create database if it doesn't exist
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = N'AvaVault')
BEGIN
    CREATE DATABASE [AvaVault];
    PRINT 'Created database [AvaVault].';
END
ELSE
    PRINT 'Database [AvaVault] already exists.';
GO
...
-- Step 3: Drop ALL existing tables (respects FK order, handles partial migrations)
...
-- Step 4: Apply full schema (idempotent EF Core migration script)
...
PRINT 'AvaVault schema created successfully.';
GO
