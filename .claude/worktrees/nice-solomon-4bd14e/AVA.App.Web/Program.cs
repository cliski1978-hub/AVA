...
builder.Services.AddScoped<ICanvasDocumentService, CanvasDocumentService>();
builder.Services.AddScoped<ICanvasInteractionService, CanvasInteractionService>();
builder.Services.AddScoped<ICanvasWindowService, CanvasWindowService>();
builder.Services.AddSingleton<IAVAPluginRegistry>(_ =>
{
