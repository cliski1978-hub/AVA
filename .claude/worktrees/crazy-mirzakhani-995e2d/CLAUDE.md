...
> Anthropic Claude instruction file for the AVA codebase.
...
|---|---|
| Backend | .NET MVC / C# |
| AI | Anthropic Claude 3.5 Sonnet (RAG pipeline) |
...
- Do not reference OpenAI or GPT models anywhere — this system uses Anthropic Claude exclusively
