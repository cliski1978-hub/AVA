...
//
//              Examples:
//                Nomi    — a character/personality identified by UUID
...
namespace AVA.UI.CORE.Models.Settings
{
    ...
    public class ModelProfile
    {
        ...
        /// For Nomi: nomi:uuid or room:roomId:nomi:nomiId
        ...
        /// For Nomi this is the character name.
        /// For other providers this is the model name.
        /// </summary>
        public string Label { get; set; } = string.Empty;

        /// <summary>
        /// Provider type hint — "nomi", "room", "openai", "venice", "ollama", etc.
        ...
        /// For Nomi: gender, relationshipType, etc
