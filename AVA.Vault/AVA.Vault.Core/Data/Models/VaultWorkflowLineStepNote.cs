...
namespace AVA.Vault.Core.Data.Models
{
    ...
    public class VaultWorkflowLineStepNote : IdentityLinkedEntityBase
    {
        public VaultWorkflowLineStepNote()
        {
        }
        ...
        [InverseProperty(nameof(VaultNote.WorkflowLineStepNotes))]
        public virtual VaultNote Note { get; set; } = null!;

        [ForeignKey(nameof(WorkflowLineStepID))]
        [InverseProperty(nameof(VaultWorkflowLineStep.WorkflowLineStepNotes))]
