...
namespace AVA.Vault.Core.Data.Models
{
    ...
    public class VaultNoteFileRef : IdentityLinkedEntityBase
    {
        public VaultNoteFileRef()
        {
        }
        ...
        [InverseProperty(nameof(VaultFileRef.NoteFileRefs))]
        public virtual VaultFileRef FileRef { get; set; } = null!;

        [ForeignKey(nameof(NoteID))]
        [InverseProperty(nameof(VaultNote.NoteFileRefs))]
