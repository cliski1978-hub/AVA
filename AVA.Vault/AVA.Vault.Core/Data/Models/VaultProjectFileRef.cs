...
namespace AVA.Vault.Core.Data.Models
{
    ...
    public class VaultProjectFileRef : IdentityLinkedEntityBase
    {
        public VaultProjectFileRef()
        {
        }
        ...
        [InverseProperty(nameof(VaultFileRef.ProjectFileRefs))]
        public virtual VaultFileRef FileRef { get; set; } = null!;

        [ForeignKey(nameof(ProjectID))]
        [InverseProperty(nameof(VaultProject.ProjectFileRefs))]
