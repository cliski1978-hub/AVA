...
namespace AVA.Vault.Core.Data.Models
{
    ...
    public class VaultSessionFileRef : IdentityLinkedEntityBase
    {
        public VaultSessionFileRef()
        {
        }
        ...
        [InverseProperty(nameof(VaultFileRef.SessionFileRefs))]
        public virtual VaultFileRef FileRef { get; set; } = null!;

        [ForeignKey(nameof(SessionID))]
        [InverseProperty(nameof(VaultSession.SessionFileRefs))]
