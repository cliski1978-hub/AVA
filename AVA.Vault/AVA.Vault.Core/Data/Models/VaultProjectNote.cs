...
namespace AVA.Vault.Core.Data.Models
{
    ...
    public class VaultProjectNote : IdentityLinkedEntityBase
    {
        public VaultProjectNote()
        {
        }
        ...
        [InverseProperty(nameof(VaultNote.ProjectNotes))]
        public virtual VaultNote Note { get; set; } = null!;

        [ForeignKey(nameof(ProjectID))]
        [InverseProperty(nameof(VaultProject.ProjectNotes))]
