...
namespace AVA.Vault.Core.Data.Models
{
    ...
    public class VaultFileRefNote : IdentityLinkedEntityBase
    {
        public VaultFileRefNote()
        {
        }
        ...
        [InverseProperty(nameof(VaultFileRef.FileRefNotes))]
        public virtual VaultFileRef FileRef { get; set; } = null!;

        [ForeignKey(nameof(NoteID))]
        [InverseProperty(nameof(VaultNote.FileRefNotes))]
